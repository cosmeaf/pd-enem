...
from contract.views.enem_view import enem_view
...
from contract.views.merito_academico_view import merito_academico_input
...
urlpatterns = [
    ...
    path('enem-upload/', enem_view, name='enem_upload'),
